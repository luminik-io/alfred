...
const SURFACES = [
  ...
  { id: "agents-roster", q: "tab=fleet&subtab=fleet", wait: "[aria-label='Agents'], .agents-deck" },
  { id: "agents-graph", q: "tab=fleet&subtab=fleet", wait: ".workflow-graph", graph: true },
];
...
async function shoot(browser, { surface, width, theme }) {
  ...
  await p.addInitScript((t) => {
    try {
      ...
      localStorage.setItem("alfred-theme", t);
      localStorage.setItem("alfred.rosterView", "workflow");
    } catch {}
  }, theme);
