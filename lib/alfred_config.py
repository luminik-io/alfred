...
_VARS: tuple[ConfigVar, ...] = (
    ...
    V(
        ...
        "hybrid",
        "engine",
        "Fleet-wide engine override for testing (claude/codex/opencode/hybrid).",
        operator=True,
    ...
    V(
        "ALFRED_OPENCODE_MODEL",
        "str",
        None,
        "engine",
        "Fleet-wide OpenCode model environment override.",
        operator=True,
    ),
    V(
        "ALFRED_DRY_RUN",
    ...
    V(
        "ALFRED_COMPACTION_MODEL",
        "str",
        None,
        "batteries",
        "Override the model used to derive compaction thresholds.",
    ),
    V(
        "ALFRED_COMPACTION_CONTEXT_TOKENS",
        "int",
        None,
        "batteries",
        "Override the active model's context window (tokens) for threshold derivation.",
    ),
    V(
        "ALFRED_TOOL_OFFLOAD",
        "bool",
        "1",
        "batteries",
        "Offload oversized tool output to a firing-scoped file; opt out with 0.",
    ),
    V(
        "ALFRED_TOOL_OFFLOAD_MAX_BYTES",
        "int",
        "50000000",
        "batteries",
        "Per-firing disk bound for offloaded tool output (~50MB).",
    ),
    V(
        "ALFRED_TOOL_OFFLOAD_PREVIEW_HEAD_LINES",
        "int",
        "20",
        "batteries",
        "Head lines kept inline alongside the offloaded-output pointer.",
    ),
    V(
        "ALFRED_TOOL_OFFLOAD_PREVIEW_TAIL_LINES",
        "int",
        "20",
        "batteries",
        "Tail lines kept inline alongside the offloaded-output pointer.",
    ),
    V(
        "ALFRED_TOOL_DIGEST",
        "bool",
    ...
    V(
        ...
        None,
        "slack",
        "Engine backing Slack converse (claude/codex/opencode/hybrid).",
        operator=True,
        choices=("claude", "codex", "opencode", "hybrid"),
    ),
    V(
    ...
    V(
        "ALFRED_FIRINGS_RETENTION_DAYS",
        "int",
        "30",
        "scheduler",
        "Offloaded tool-output (state/firings) retention in days for normal cleanup.",
    ),
    V(
        "ALFRED_EMERGENCY_FIRINGS_RETENTION_DAYS",
        "int",
        "1",
        "scheduler",
        "Offloaded tool-output retention in days under emergency cleanup.",
    ),
    V(
    ...
    V(
        ...
        None,
        "internal",
        "Active model exported into a firing so the compaction hook can size budgets.",
    ),
    V(
        "ALFRED_ACTIVE_ENGINE",
        "str",
        None,
        "internal",
        "Active engine exported into a firing for the compaction hook.",
    ),
    ...
    V(
        ...
        None,
        "runtime",
        "Absolute path to the codex CLI (defaults to PATH).",
        operator=True,
    ),
    V(
        "OPENCODE_BIN",
        ...
        None,
        "runtime",
        "Absolute path to the OpenCode CLI (defaults to PATH).",
        operator=True,
    ),
    V(
