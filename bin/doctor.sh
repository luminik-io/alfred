...
setup_runtime_static_config_key() {
  case "$1" in
    ALFRED_SENIOR_DEV_AWS_PROFILE|ALFRED_PLANNER_AWS_PROFILE|ALFRED_TEST_ENGINEER_AWS_PROFILE|ALFRED_REVIEWER_AWS_PROFILE|ALFRED_FIXER_AWS_PROFILE|ALFRED_TRIAGE_AWS_PROFILE|ALFRED_ARCHITECT_AWS_PROFILE|ALFRED_SPEC_PLANNER_AWS_PROFILE|ALFRED_AUTOMERGE_AWS_PROFILE|ALFRED_AGENT_CLEANUP_AWS_PROFILE|ALFRED_MEMORY_HARVEST_AWS_PROFILE|ALFRED_MEMORY_AUTO_PROMOTE_AWS_PROFILE|ALFRED_CODE_MAP_REFRESH_AWS_PROFILE|ALFRED_AGENT_MORNING_BRIEF_AWS_PROFILE|ALFRED_FLEET_DOCTOR_AWS_PROFILE|ALFRED_FLEET_RECAP_MORNING_AWS_PROFILE|ALFRED_FLEET_RECAP_EVENING_AWS_PROFILE|ALFRED_SHIPPED_SUMMARY_DAILY_AWS_PROFILE|ALFRED_SHIPPED_SUMMARY_WEEKLY_AWS_PROFILE)
      return 0
      ;;
