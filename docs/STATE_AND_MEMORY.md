...
The brain ships as opt-in. Enable it by configuring the outbox drainer in `agents.conf`. See [Fleet brain](./FLEET_BRAIN.md) for the full design, schema, and CLI.
