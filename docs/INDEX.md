...
- [`MCP.md`](MCP.md): the read-only memory and code-graph servers Alfred attaches to Claude Code and explicitly selected OpenCode firings, plus tool scoping, startup checks, safety, and configuration. Codex firings get no MCP.
