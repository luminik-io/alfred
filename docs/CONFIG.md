...
| `ALFRED_MERGE_REQUIRED_EXTERNAL_REVIEWS` | str | `` | operator | External review summaries that must be clean on the exact head. Empty means GitHub's native review settings only. |
