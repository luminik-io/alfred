...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines: string[] = [
    ...
    "Batman, Lucius, Drake, Ra's al Ghul, Bane, Nightwing, Robin, Huntress,",
    "and Gordon, while the machine keeps using the stable role slugs.",
    ...
    "Drake scopes as planner, Batman coordinates approved `agent:large-feature`",
    "bundles as architect, Lucius and Bane open implementation and test PRs,",
    "Ra's al Ghul reviews, Nightwing handles high-priority review feedback, and",
    "automerge only lands PRs that satisfy your merge policy.",
    ...
    "- Batman is the default-theme name for `architect`. Architect handles multi-repo work via",
