...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines: string[] = [
    ...
    "triage, Huntress and Gordon load with the fleet and self-idle until their",
    "staging smoke or ECS settings exist, and the memory, code-map, cleanup,",
    "briefing, recap, shipped-summary, and fleet-doctor jobs keep the loop",
    "inspectable.",
