...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines: string[] = [
    ...
    "It coordinates authenticated Claude Code and Codex CLI sessions on a",
    ...
    "",
    "A coding-harness session handles the current prompt. Alfred schedules selected",
    ...
    "  harness still sends the context it uses to its model provider.",
