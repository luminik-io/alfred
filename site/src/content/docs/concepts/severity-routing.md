...
- [`docs/SLACK_SETUP.md`](https://github.com/luminik-io/alfred/blob/main/docs/SLACK_SETUP.md): the full guide.
- [`agent_runner.slack_post`](https://github.com/luminik-io/alfred/blob/main/lib/agent_runner.py): the source.
