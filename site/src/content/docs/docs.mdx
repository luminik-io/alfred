---
title: Alfred
description: Alfred turns Claude Code and Codex into a spec-driven engineering team. Named agents plan the work, write the code, review each other, and open pull requests, on your machine, behind an approval gate.
template: splash
head:
  - tag: title
    content: "Alfred: an autonomous engineering team on Claude Code and Codex"
hero:
  tagline: "Named agents plan the work, write the code, review each other, and open pull requests. On your machine, behind an approval gate."
  image:
