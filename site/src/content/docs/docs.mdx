...
hero:
  tagline: "Claude Code and Codex plan work, write code, test it, review each other, and open pull requests. Alfred keeps working without you at the keyboard. You approve risky actions and decide what merges."
  image:
...
harness sessions as one autonomous engineering team.
