...
<CardGrid>
  ...
  <Card title="Worktree isolation" icon="puzzle">
    Each firing works in a dedicated git worktree, with locks and recovery around the lifecycle.
  </Card>
...
- Explicit repository scope. No silent discovery or cloning.
...
The latest tagged release is v0.6.0. Claude Code and Codex are the validated
execution engines. OpenCode and other harnesses remain evaluation work until
they pass the same authentication, permission, isolation, and event-contract
checks.
