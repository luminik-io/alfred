---
title: Alfred
description: Alfred turns Claude Code and Codex into a small, named engineering team that remembers. Agents plan, build, review each other, and open pull requests, and every run teaches the fleet a lesson it keeps.
template: splash
head:
  - tag: title
    content: "Alfred: an engineering team, built on Claude Code and Codex, that remembers"
hero:
  tagline: "Named agents plan, build, review each other, and open pull requests, and every run teaches the fleet something it keeps."
  image:
