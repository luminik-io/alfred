...
status. The default `ARCHITECT_AUTO_EXECUTE=0` halts after the plan for manual
...
[docs/ARCHITECT.md](https://github.com/luminik-io/alfred/blob/main/docs/ARCHITECT.md).
If `ARCHITECT_PARENT_REPO` is a specs or planning repo outside `--repos`, run
