...
<CardGrid>
  ...
  <Card title="Ops departments" icon="setting">Personal-assistant, finance, product-ops — drafts-only on anything that sends, publishes, or pays.</Card>
...
Alfred stays single-operator and local by design — not multi-tenant, not a hosted SaaS. The full [roadmap](/about/roadmap/) has what's in flight and the design boundaries that hold.
