...
- [`launchd/_template.plist`](https://github.com/luminik-io/alfred/blob/main/launchd/_template.plist): the canonical template with `__PLACEHOLDER__` tokens.
- [`launchd/agents.conf.example`](https://github.com/luminik-io/alfred/blob/main/launchd/agents.conf.example): TSV format documentation.
- [`launchd/render.sh`](https://github.com/luminik-io/alfred/blob/main/launchd/render.sh): substitutes tokens, writes one plist per row.
