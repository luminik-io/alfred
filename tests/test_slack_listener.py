...
from slack_surface.listener import (  # noqa: E402
...
def _intent_catalog():
    from slack_surface.intent import RepoCatalog
...
def test_looks_like_status_or_answer_precision() -> None:
    from slack_surface.listener import _looks_like_status_or_answer
...
def test_repos_from_text_trims_trailing_sentence_punctuation() -> None:
    from slack_surface.listener import _repos_from_text
...
def test_converse_offer_signature_round_trips_across_turns(tmp_path: Path) -> None:
    ...
    from slack_surface.converse import SlackConverseConfig
    from slack_surface.threads import SlackThreadRecord
...
def test_client_is_connected_probes_defensively() -> None:
    from slack_surface.listener import _client_is_connected
...
def test_reconnect_socket_mode_resets_backoff_on_success() -> None:
    from slack_surface.listener import _reconnect_socket_mode
...
def test_env_float_listener_rejects_non_finite(monkeypatch) -> None:
    from slack_surface.listener import _env_float_listener
...
def test_reconnect_base_backoff_floored_positive(monkeypatch) -> None:
    from slack_surface.listener import _reconnect_base_backoff_s
